...
This guide walks you through setting up, developing, and deploying a Topia SDK application using the sdk-ai-advanced-boilerplate.
...
The sdk-ai-advanced-boilerplate uses a **monorepo structure** with separate client and server workspaces:
