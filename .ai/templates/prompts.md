...
1. Create getBadges utility to fetch ecosystem badges (see sdk-ai-advanced-boilerplate examples/badges.md)
...
### Add Inventory Cache
```
Add cached inventory for badges (see sdk-ai-advanced-boilerplate examples/inventoryCache.md):
...
```
Add functionality to award a badge to a visitor (see sdk-ai-advanced-boilerplate examples/awardBadge.md):
...
### Add XP System
```
Add an Experience Points system to this app (see sdk-ai-advanced-boilerplate examples/experiencePoints.md):
...
```
Add XP granting to this controller (see sdk-ai-advanced-boilerplate examples/experiencePoints.md):
...
```
Update the game state endpoint to read XP from inventory (see sdk-ai-advanced-boilerplate examples/experiencePoints.md):
...
```
Add ability to drop assets into the world (see sdk-ai-advanced-boilerplate examples/handleDropAssets.md):
...
```
Add ability to remove a dropped asset (see sdk-ai-advanced-boilerplate examples/handleRemoveDroppedAsset.md):
...
```
Add ability to remove multiple dropped assets (see sdk-ai-advanced-boilerplate examples/handleRemoveDroppedAssets.md):
...
```
Add ability to update a dropped asset (see sdk-ai-advanced-boilerplate examples/handleUpdateDroppedAsset.md):
1. Get the dropped asset by ID
...
```
Add configuration endpoint (see sdk-ai-advanced-boilerplate examples/handleGetConfiguration.md):
...
### Get Anchor Assets
```
Add utility to fetch anchor assets (see sdk-ai-advanced-boilerplate examples/getAnchorAssets.md):
...
### Reset Game State
```
Add admin-only game reset functionality (see sdk-ai-advanced-boilerplate examples/handleResetGameState.md):
...
```
Add a leaderboard system to this app (see sdk-ai-advanced-boilerplate examples/leaderboard.md):
...
```
Add utility to update leaderboard (see sdk-ai-advanced-boilerplate examples/leaderboard.md):
...
```
Add leaderboard table to admin UI (see sdk-ai-advanced-boilerplate examples/leaderboard.md):
...
```
Add leaderboard entry removal when visitor restarts (see sdk-ai-advanced-boilerplate examples/leaderboard.md):
...
```
Add toast notification functionality (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md):
...
```
Add visitor movement to an asset location (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md):
...
### Teleport Visitor
```
Add teleport functionality (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md):
...
### Manage Iframes
```
Add iframe open/close functionality (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md):
...
```
Add locking to prevent race conditions (see sdk-ai-advanced-boilerplate examples/lockingPatterns.md):
...
```
Add turn-based multiplayer (see sdk-ai-advanced-boilerplate examples/lockingPatterns.md):
...
```
Build a turn-based multiplayer game (see sdk-ai-advanced-boilerplate examples/multiplayerTurnBased.md):
...
```
Add player selection/joining for multiplayer (see sdk-ai-advanced-boilerplate examples/multiplayerTurnBased.md):
...
```
Add analytics tracking to the app (see sdk-ai-advanced-boilerplate examples/analyticsTracking.md):
...
```
Add completion tracking (see sdk-ai-advanced-boilerplate examples/analyticsTracking.md):
...
```
Add particle effects (see sdk-ai-advanced-boilerplate examples/worldActivity.md):
...
```
Add activity indicators (see sdk-ai-advanced-boilerplate examples/worldActivity.md):
...
```
Add user feedback on action completion (see sdk-ai-advanced-boilerplate examples/worldActivity.md):
...
### Migrate Data Schema
```
Add data migration for schema changes (see sdk-ai-advanced-boilerplate examples/dataMigration.md):
...
```
Add versioned data migration (see sdk-ai-advanced-boilerplate examples/dataMigration.md):
...
Use the patterns from sdk-ai-advanced-boilerplate/.ai/examples/ for implementation.
```
...
| Feature | Prompt |
|---------|--------|
| Badges | "Add badges system (see sdk-ai-advanced-boilerplate examples/badges.md)" |
| Inventory Cache | "Add cached inventory (see sdk-ai-advanced-boilerplate examples/inventoryCache.md)" |
| Award Badge | "Add badge awarding (see sdk-ai-advanced-boilerplate examples/awardBadge.md)" |
| Experience Points | "Add XP system (see sdk-ai-advanced-boilerplate examples/experiencePoints.md)" |
| Drop Asset | "Add asset dropping (see sdk-ai-advanced-boilerplate examples/handleDropAssets.md)" |
| Remove Asset | "Add asset removal with effects (see sdk-ai-advanced-boilerplate examples/handleRemoveDroppedAsset.md)" |
| Configuration | "Add config endpoint (see sdk-ai-advanced-boilerplate examples/handleGetConfiguration.md)" |
| Game Reset | "Add admin reset (see sdk-ai-advanced-boilerplate examples/handleResetGameState.md)" |
| Leaderboard | "Add leaderboard system (see sdk-ai-advanced-boilerplate examples/leaderboard.md)" |
| Toast Notifications | "Add toast notifications (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md)" |
| Move/Teleport Visitor | "Add visitor movement (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md)" |
| Iframe Management | "Add iframe open/close (see sdk-ai-advanced-boilerplate examples/visitorInteractions.md)" |
| Concurrency Locking | "Add locking for multiplayer (see sdk-ai-advanced-boilerplate examples/lockingPatterns.md)" |
| Multiplayer Game | "Build turn-based game (see sdk-ai-advanced-boilerplate examples/multiplayerTurnBased.md)" |
| Analytics | "Add analytics tracking (see sdk-ai-advanced-boilerplate examples/analyticsTracking.md)" |
| Particle Effects | "Add particle effects (see sdk-ai-advanced-boilerplate examples/worldActivity.md)" |
| Activity Indicators | "Add world activity indicators (see sdk-ai-advanced-boilerplate examples/worldActivity.md)" |
| Data Migration | "Add data migration (see sdk-ai-advanced-boilerplate examples/dataMigration.md)" |
...
1. **Reference the example**: Always mention "see sdk-ai-advanced-boilerplate examples/[filename].md" so Claude knows which pattern to follow
...
4. **Chain features**: Combine related prompts:
   ...
   See sdk-ai-advanced-boilerplate examples/badges.md
   ```

5. **Update documentation**: After implementation, ask:
   ```
   Update sdk-ai-advanced-boilerplate documentation if this pattern is reusable across apps
   ```

6. **For multiplayer/games**: Always include locking:
   ```
   This is a multiplayer feature. Add locking to prevent race conditions.
   See sdk-ai-advanced-boilerplate examples/lockingPatterns.md
   ```
...
7. **For visitor feedback**: Combine interactions:
   ...
   See sdk-ai-advanced-boilerplate examples/visitorInteractions.md
   ```
